...
def detect_and_contour_dark_area(image_path, output_path):
    ...
    if contours:
        ...
        cv2.drawContours(image, [largest_contour], -1, (0, 0, 255), 3)  # Draw in red with thickness 3
    
    cv2.imwrite(output_path, image)
    print(f"Koyu alan tespiti yapılmış ve kırmızı ile kontur eklenmiş resim kaydedildi: {output_path}")
...
def main():
    ...
    if image1_path and image2_path:
        ...
        detect_and_contour_dark_area(merged_image_path, edges_image_path)
